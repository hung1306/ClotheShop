...
namespace AuthenticShop.Data.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductPhoto = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    SizeId = table.Column<int>(type: "int", nullable: false),
                    ColorId = table.Column<int>(type: "int", nullable: false),
                    IsTrend = table.Column<bool>(type: "bit", nullable: false),
                    IsArrvied = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
